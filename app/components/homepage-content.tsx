// Shared homepage content, rendered at "/" and at the QR-tracking paths
// "/postcard" and "/bookmark" (see app/postcard/page.tsx, app/bookmark/page.tsx).
//
// Cloudflare Web Analytics deliberately does not log query strings (confirmed
// in their own docs), so UTM-style tracking via ?utm_source=... is invisible
// to it. Distinct real paths are the only thing Cloudflare's "Top Paths"
// report actually differentiates — hence separate routes instead of one
